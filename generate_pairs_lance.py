...
with open(".\Feature_files\lmfeat_mean.pkl", "rb") as f:
    d = pickle.load(f)
...
for assignment in assignments:
    scaler = MinMaxScaler()
    scaler.fit(assignments[assignment][:,:57])
    assignments[assignment][:,:57] = scaler.transform(assignments[assignment][:,:57])
...
with open("D:\plagtool\\all_proc_u_lance.pkl", "wb") as f:
